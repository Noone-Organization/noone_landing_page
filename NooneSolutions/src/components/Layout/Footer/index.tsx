          ...
          <div className="lg:col-span-4 md:col-span-6 col-span-6">
            ...
            <div className="flex gap-6 items-center mt-8">
              <Link href="#" className="group">
                <Icon icon="fa6-brands:facebook-f" width="24" className="text-white group-hover:text-primary" />
              </Link>
              <Link href="#" className="group">
                <Icon icon="fa6-brands:instagram" width="24" className="text-white group-hover:text-primary" />
              </Link>
              <Link href="#" className="group">
                <Icon icon="fa6-brands:x-twitter" width="24" className="text-white group-hover:text-primary" />
              </Link>
            </div>
