      ...
      <div className="lg:py-0 py-2">
        ...
        >
          ...
          <div className="flex items-center gap-4 pl-4">
            <button onClick={() => setLang("es")}>
              <Image src="/flags/es.png" width={28} height={28} alt="ES" className={`${lang === "es" ? "opacity-100" : "opacity-40"}`} />
            </button>
            <button onClick={() => setLang("en")}>
              <Image src="/flags/en.png" width={28} height={28} alt="EN" className={`${lang === "en" ? "opacity-100" : "opacity-40"}`} />
            </button>
            <button onClick={() => setLang("de")}>
              <Image src="/flags/de.png" width={28} height={28} alt="DE" className={`${lang === "de" ? "opacity-100" : "opacity-40"}`} />
            </button>
          </div>
